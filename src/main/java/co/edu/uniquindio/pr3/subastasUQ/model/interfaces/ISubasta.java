...
public interface ISubasta {
    ...
    public boolean crearAnunciante(String nombres, String apellidos, String identificacion, int edad, Subasta subastasQuindio, String usuario, String contrasenia, String email, Boolean isAutenticado) throws AnuncianteException, UsuarioEnUsoException;
    ...
    public boolean crearComprador(String nombres, String apellidos, String identificacion, int edad, Subasta subastasQuindio, String usuario, String contrasenia, String email, Boolean isAutenticado) throws CompradorException, UsuarioEnUsoException;
